...
<section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">DATA SISWA SMKN1 BATU</h1>
        <p class="lead text-muted">Merupakan informasi siswa yang telah terdaftar di SMK Negeri 1 Kota Batu</p>
        <p>
          <a href="daftar.php" class="btn btn-primary my-2">Daftar Baru</a>
          <a href="list.php" class="btn btn-secondary my-2">List</a>
        </p>
